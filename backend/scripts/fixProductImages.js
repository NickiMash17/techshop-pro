...
const getImageForProduct = (product) => {
  ...
  if (
    ...
    name.includes("canon") ||
    name.includes("nikon") ||
    name.includes("sony a7") ||
    name.includes("lens") ||
    name.includes("fe 24-70")
  ) {
  ...
  if (
    ...
    name.includes("focusrite") ||
    name.includes("yamaha") ||
    name.includes("native instruments") ||
    name.includes("komplete")
  ) {
  ...
  if (
    ...
    name.includes("peloton") ||
    name.includes("nordictrack") ||
  ...
  if (
    ...
    name.includes("boost charge") ||
    name.includes("belkin") ||
...
const fixProductImages = async () => {
  try {
    ...
    sampleProducts.forEach((product) => {
      console.log(
        `  ${product.name} (${product.category}): ${product.imageUrl ? "✅ Has image" : "❌ No image"}`,
      );
    });
