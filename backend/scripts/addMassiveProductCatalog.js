...
const massiveProductCatalog = [
  // Smartphones - Premium & Mid-range
  {
    ...
    price: 1199.99,
    description: "Apple's flagship with A17 Pro chip, titanium design, and 5x optical zoom.",
    stock: 15,
  ...
  },
  {
    ...
    price: 1299.99,
    description: "Ultimate Android flagship with S Pen, AI features, and titanium frame.",
    stock: 12,
    category: "Smartphones",
    imageUrl: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 999.99,
    description: "Photography-focused flagship with Leica optics and 1-inch sensor.",
    stock: 18,
    category: "Smartphones",
    imageUrl: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 999.99,
    description: "2-in-1 laptop-tablet with Intel processor and detachable keyboard.",
    stock: 15,
    category: "Tablets",
    imageUrl: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 649.99,
    description: "Android tablet with AMOLED display and productivity features.",
    stock: 22,
    category: "Tablets",
    imageUrl: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=500",
    specs: {
  ...
  // Laptops - Gaming & Professional
  {
    name: "Alienware x16",
    price: 2999.99,
    description: "Premium gaming laptop with RTX 4090 and 16-inch QHD+ display.",
    stock: 8,
    category: "Laptops",
  ...
  },
  {
    ...
    price: 1899.99,
    description: "Business ultrabook with 14-inch display and enterprise features.",
    stock: 12,
    category: "Laptops",
    imageUrl: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500",
    specs: {
  ...
  // Gaming - Consoles & Accessories
  {
    ...
    price: 399.99,
    description: "Next-generation Nintendo console with enhanced graphics and performance.",
    stock: 30,
    category: "Gaming",
  ...
  },
  {
    ...
    price: 549.99,
    description: "Enhanced Steam Deck with OLED display and improved battery life.",
    stock: 20,
    category: "Gaming",
    imageUrl: "https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 549.99,
    description: "Next-generation VR headset for PlayStation 5 with 4K HDR display.",
    stock: 15,
    category: "Gaming",
    imageUrl: "https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=500",
    specs: {
  ...
  },
  {
    ...
    stock: 15,
    category: "Photography",
    imageUrl: "https://images.unsplash.com/photo-1579829366248-204fe8413f31?w=500",
    specs: {
  ...
  // Audio - Studio & Consumer
  {
    ...
    price: 299.99,
    description: "Open-back studio headphones with exceptional detail and comfort.",
    stock: 18,
    category: "Audio",
  ...
  },
  {
    ...
    price: 899.99,
    description: "Professional audio interface with DSP processing and premium preamps.",
    stock: 10,
    category: "Audio",
  ...
  },
  {
    name: "KRK Rokit 7 G4",
    price: 199.99,
    description: "Professional studio monitor with DSP room tuning and bi-amp design.",
    stock: 25,
    category: "Audio",
    imageUrl: "https://images.unsplash.com/photo-1598653222000-6b7b7a552625?w=500",
    specs: {
  ...
  // Fitness - Wearables & Equipment
  {
    ...
    price: 999.99,
    description: "Premium multisport watch with solar charging and advanced metrics.",
    stock: 12,
    category: "Fitness",
  ...
  },
  {
    ...
    price: 999.99,
    description: "Professional rowing machine with PM5 monitor and smooth performance.",
    stock: 8,
    category: "Fitness",
    imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500",
    specs: {
  ...
  // Office - Productivity & Ergonomics
  {
    ...
    price: 1495.00,
    description: "Iconic ergonomic office chair with PostureFit SL and breathable mesh.",
    stock: 10,
    category: "Office",
  ...
  },
  {
    ...
    price: 169.99,
    description: "Mechanical keyboard with Cherry MX switches and aluminum frame.",
    stock: 30,
    category: "Office",
    imageUrl: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500",
    specs: {
  ...
  // Accessories - Cables & Storage
  {
    ...
    price: 149.99,
    description: "High-capacity power bank with 140W output and digital display.",
    stock: 40,
  ...
  },
  {
    ...
    price: 299.99,
    description: "Rugged portable SSD with Thunderbolt 3 and military-grade protection.",
    stock: 20,
    category: "Accessories",
    imageUrl: "https://images.unsplash.com/photo-1609592806598-04d4d2d88548?w=500",
    specs: {
