...
const additionalProducts = [
  ...
  },
  {
    name: "Xbox Series X",
    price: 499.99,
    description: "The most powerful Xbox ever with 4K gaming, ray tracing, and 120 FPS support.",
    stock: 20,
    category: "Gaming",
  ...
  },
  {
    ...
    price: 89.99,
    description: "Smart display with Google Assistant, perfect for home control and entertainment.",
    stock: 35,
    category: "Smart Home",
  ...
  },
  {
    ...
    stock: 15,
    category: "Smart Home",
    imageUrl: "https://images.unsplash.com/photo-1565814636199-ae8133055c1c?w=500",
    specs: {
  ...
  // Audio & Music
  {
    ...
    price: 149.99,
    description: "Professional studio monitor headphones with exceptional clarity and comfort.",
    stock: 40,
    category: "Audio",
  ...
  },
  {
    ...
    price: 169.99,
    description: "USB audio interface with 2 inputs, perfect for recording vocals and instruments.",
    stock: 22,
    category: "Audio",
  ...
  },
  {
    ...
    price: 349.99,
    description: "Professional studio monitor with 8-inch woofer for accurate sound reproduction.",
    stock: 15,
    category: "Audio",
    imageUrl: "https://images.unsplash.com/photo-1598653222000-6b7b7a552625?w=500",
    specs: {
  ...
  // Fitness & Health
  {
    name: "Peloton Bike+",
    price: 2495.00,
    description: "Premium smart bike with 24-inch rotating HD touchscreen and live classes.",
    stock: 8,
    category: "Fitness",
  ...
  },
  {
    name: "Garmin Fenix 7",
    price: 699.99,
    description: "Premium multisport GPS watch with advanced training metrics and solar charging.",
    stock: 12,
    category: "Fitness",
    imageUrl: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 199.99,
    description: "Electric standing desk converter with memory presets and smooth height adjustment.",
    stock: 25,
    category: "Office",
    imageUrl: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500",
    specs: {
  ...
  },
  {
    ...
    price: 169.99,
    description: "Professional USB microphone with LED metering and multiple pickup patterns.",
    stock: 18,
    category: "Office",
    imageUrl: "https://images.unsplash.com/photo-1598653222000-6b7b7a552625?w=500",
    specs: {
