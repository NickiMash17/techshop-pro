                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="px-3 py-1 bg-surface rounded-lg hover:bg-surface/70 transition-colors text-white"
                    >
                      -
                    </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-surface/50 p-6 rounded-xl sticky top-24">
              ...
              <button
                ...
                className="w-full mt-6 py-3 bg-gradient-to-r from-primary to-secondary rounded-lg font-medium hover:opacity-90 transition-opacity text-white"
              >
                Proceed to Checkout
              </button>
            </div>
